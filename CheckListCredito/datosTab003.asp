...
sql = ""
sql = sql & "select id_carpeta, "
sql = sql & "case a.tipo_pens_trab when 30 then 'TRAB' when 32 then 'PEN' "
sql = sql & "end as segmento, "
sql = sql & "a.num_credito, a.fecha_colocacion,  "
sql = sql & "cast(a.rut_cliente as varchar(10))+'-'+a.dv_cliente as rutcliente ,a.id_codigo_barra as caja,  "
...
sql = sql & "from SUC_vcc_carpeta_credito a inner join SUC_vcc_Nombre_Cliente e on a.rut_cliente = e.rut_cliente "
sql = sql & "inner join SUC_sucursal suc on a.cod_sucursal = suc.cod_bantotal "
