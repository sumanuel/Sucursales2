...
<input type="hidden" name="idComboRepro" id="idComboRepro" value="3">
...
<table id="tableP003" class="table table-bordered table-hover table-condensed table-striped" data-anio2="<%=anio%>" data-mes2="<%=mes%>" data-idsucursal="<%=id_sucursal%>" data-perfil="<%=perfilMain%>" data-usuario="<%=idUsuarioMain%>" data-idSucursalMain="<%=idSucursalMain%>">
<thead>
<tr>
    <th><strong>Carpeta</strong></th>
    <th><strong>Cliente</strong></th>    
    <th><strong>Op</strong></th>
    <th><strong>Fec Repro</strong></th>    
    <th><strong>Cliente</strong></th>
...
$(document).ready(function (){
  var mes = $('#tableP003').attr('data-mes2');
  var anio = $('#tableP003').attr('data-anio2');
  var id_sucursal = $('#tableP003').attr('data-idsucursal');
  var idUsuarioMain = $('#tableP003').attr('data-usuario');
  var perfilMain = $('#tableP003').attr('data-perfil');
  var idSucursalMain = $('#tableP003').attr('data-idSucursalMain');
  //alert(perfilMain);
  var url = 'CheckListCredito/datosTab003.asp?mes='+mes+'&anio='+anio+'&id_sucursal='+id_sucursal+'&perfilMain='+perfilMain+'&idUsuarioMain='+idUsuarioMain+'&idSucursalMain='+idSucursalMain;  
  var table = $('#tableP003').DataTable( {
    "ajax": url,    
...
function abreModal(idCarpeta, tipCliente){
  var idUsuario = $('#tableP003').attr('data-usuario');
