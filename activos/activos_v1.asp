...
<div class="row-fluid">
	<div class="span4"></div>
	<div class="span4 well">Ante dudas o consultas sobre sus activos por favor comunicarse con :<br>
		<strong>Bernardo Daniel De La Peña Perez</strong> al correo <strong>bpena@losheroes.cl</strong>
	</div>
	<div class="span4"></div>
</div>
<div class="row-fluid">
