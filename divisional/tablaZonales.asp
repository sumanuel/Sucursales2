...
<%totalCampos = 4%>
<div class="row-fluid" id="divTablaDatosGerencia">
	<div class="span12" id="tablaDatos">
		<table class="table table-bordered" id="tablaDatosGerencia">
			<thead>
				<tr>
					<th>
						Zona
			...
			<tbody>
				...
				sql2 = sql2 & " where estado_zonal = '1' "
				...
				for x=0 to ubound(datosZonal,2)
					...
					<tr class="abreTrSucursales mano muestra info" data-idZonal="<%=idZonal%>">
						...
						<td>
							<div id="aperturaSucursalZonal<%=idZonal%>"></div>
						</td>
						<td>
