		...
		<div class="span10 gestion mano" id="datosRegional" data-idRegional="<%=idRegional%>">
			...
			<div class="row-fluid">
				<div class="span3 well">
					...
					<div class="span8">
						<span class="label label-info">Total cajeros</span>
						<span id="totalCajeros<%=idRegional%>" class="label label-info"></span>
					</div>
				</div>
				<div class="span9">
					<div class="row-fluid">
							...
							<div class="row-fluid">
								...
								<div class="span8">
									<div class="row-fluid">
										...
										<div class="span6">
											<span class="label label-info" id="adicionales<%=idRegional%>"></span>
										</div>
									</div>
									<div class="row-fluid">
										<div class="span6">
										...
										<div class="span6">
											<span class="label label-important" id="sinRegistro<%=idRegional%>"></span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row-fluid">
							<div class="span3 well">
								<div class="row-fluid">
									...
									<div class="span8">
										<span class="label label-info">Total cajeros</span>
										<span id="totalCajerosZonal<%=idZonal%>Regional<%=idRegional%>" class="label label-info"></span>
									</div>
								</div>
							</div>
							<div class="span9">
										...
										<div class="row-fluid">
											...
											<div class="span8">
												<div class="row-fluid">
													...
													<div class="span6">
														<span class="label label-info" id="adicionalesRegional<%=idRegional%>Zonal<%=idZonal%>"></span>
													</div>
												</div>
												<div class="row-fluid">
													<div class="span6">
										...
										<div class="row-fluid">
											...
											<div class="span8">
												...
												<div class="row-fluid">
													...
													<div class="span6">
														<span class="label label-info" id="presentesRegional<%=idRegional%>Zonal<%=idZonal%>"></span>
													</div>
												</div>
											</div>
										</div>
...
$(function(){
	...
	url = 'sucursales/detalleGestionSucursalCajeros.asp?idRegional='+idRegional;
	$.when($.ajax(url)).then(function(data) {
		$.each( data.datosZonales, function( key, valoresZonales ) {
			...
			totalCajerosTitulares = valoresZonales.totalCajerosTitulares;
			totalCajerosReemplazos = valoresZonales.totalCajerosReemplazos;
			totalCajerosAdicionales = valoresZonales.totalCajerosAdicionales;
			totalSinRegistro = valoresZonales.totalSinRegistro;
			totalAusentes = valoresZonales.totalAusentes2;
			totalPresentes = valoresZonales.totalPresentes;
			totalCajeros = valoresZonales.totalCajeros;
			$('#totalTitularesRegional'+idRegional+'Zonal'+idZonal2).html(totalCajerosTitulares);
			$('#reemplazoRegional'+idRegional+'Zonal'+idZonal2).html(totalCajerosReemplazos);
			$('#adicionalesRegional'+idRegional+'Zonal'+idZonal2).html(totalCajerosAdicionales);
			$('#sinRegistroRegional'+idRegional+'Zonal'+idZonal2).html(totalSinRegistro);
			$('#ausentesRegional'+idRegional+'Zonal'+idZonal2).html(totalAusentes);
			$('#presentesRegional'+idRegional+'Zonal'+idZonal2).html(totalPresentes);
			$('#nombreZonal'+idZonal2+'Regional'+idRegional).html('<span class="label label-info">'+nombreZonal+'</span>');
			$('#totalCajerosZonal'+idZonal2+'Regional'+idRegional).html(totalCajeros);
		});
		...
		$.each(data.datosRegionales, function(key, valorDaTosRegionales){
			...
			totalCajerosTitulares = valorDaTosRegionales.totalCajerosTitulares;
			totalCajerosReemplazos = valorDaTosRegionales.totalCajerosReemplazos;
			totalCajerosAdicionales = valorDaTosRegionales.totalCajerosAdicionales;
			totalSinRegistro = valorDaTosRegionales.totalSinRegistro;
			totalAusentes = valorDaTosRegionales.totalAusentes2;
			totalPresentes = valorDaTosRegionales.totalPresentes;
			totalCajeros = valorDaTosRegionales.totalCajeros;
			$('#totalTitulares'+idRegional).html(totalCajerosTitulares);
			$('#reemplazo'+idRegional).html(totalCajerosReemplazos);
			$('#adicionales'+idRegional).html(totalCajerosAdicionales);
			$('#sinRegistro'+idRegional).html(totalSinRegistro);
			$('#ausentes'+idRegional).html(totalAusentes);
			$('#presentes'+idRegional).html(totalPresentes);
			$('#totalCajeros'+idRegional).html(totalCajeros);
		});
	});	
...
$('.seleccionaZonal').click(function() {
	...
	pagina = 'sucursales/tablaCuadrosSucursalesCajeros.asp';
