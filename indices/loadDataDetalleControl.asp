...
sql = sql & " from SUC_zonales_comercial_mas "
...
if not rs.eof then
	...
	For i = 0 to ubound(datos, 2)
		...
		sql2 = sql2 & " (select id_sucursal from SUC_zonales_comercial_mas_sucursal "
		...
		sql2 = sql2 & " and a.id_sucursal in (select id_sucursal from SUC_zonales_comercial_mas_sucursal "
		sql2 = sql2 & " where id_zonal = '"&idZonal&"') "
...
'################################################################################
		...
		sql2 = sql2 & " from SUC_zonales_comercial_mas_sucursal "
		...
		sql2 = sql2 & " from( "
		sql2 = sql2 & " select a.id_zonal_mas, "
		...
		sql2 = sql2 & " group by z.id_zonal_mas, z.id_usuario "
		set rs2 = db.execute(sql2)
		if not rs2.eof then
			datos2 = rs2.GetRows()
...
'##########################################################################
	...
	sql2 = sql2 & " SUC_zonales_comercial_mas_sucursal where "
	...
	sql2 = sql2 & " from SUC_zonales_comercial_mas_sucursal where "
	sql2 = sql2 & " id_zonal = z.id_usuario))) as float)) as porc "
	sql2 = sql2 & " from( select "
	sql2 = sql2 & " a.id_zonal_mas, "
	sql2 = sql2 & " a.id_usuario, "
	sql2 = sql2 & " a.zonal_mas, "
	sql2 = sql2 & " c.id_sucursal, "
	sql2 = sql2 & " c.suc_nombre, "
...
'##########################################################################
		...
		sql2 = ""
		sql2 = sql2 & " select y.id_usuario, y.zonal_mas, y.porc_apertura, y.porc_sinr, y.porc_cerradas "
		sql2 = sql2 & " from ( "
		sql2 = sql2 & " select z.id_usuario, z.zonal_mas, "
		...
		sql2 = sql2 & " id_sucursal in ( "
		sql2 = sql2 & " select id_sucursal from SUC_zonales_comercial_mas_sucursal " 
		sql2 = sql2 & " where id_zonal = w.id_usuario)) as total_apertura, "
		sql2 = sql2 & " (select COUNT(*) from SUC_sucursal_apertura "
		sql2 = sql2 & " where fecha_ingreso = cast(GETDATE() as DATE) and tipo = 2 and "
		sql2 = sql2 & " id_sucursal in ( "
		sql2 = sql2 & " select id_sucursal from SUC_zonales_comercial_mas_sucursal "
		sql2 = sql2 & " where id_zonal = w.id_usuario)) as total_cerrada "
		sql2 = sql2 & " from ( "
		sql2 = sql2 & " select z.id_usuario, z.zonal_mas, "
		sql2 = sql2 & " (select COUNT(*) from SUC_zonales_comercial_mas_sucursal where id_zonal = z.id_usuario) as total "
		sql2 = sql2 & " from ( "
		sql2 = sql2 & " select id_usuario, zonal_mas from SUC_zonales_comercial_mas where id_usuario = '"&idZonal&"' "
