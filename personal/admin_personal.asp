...
'Obtener hora límite desde configuración
dim horaLimiteReemplazos
horaLimiteReemplazos = obtenerConfiguracion("PERSONAL", "HORA_LIMITE_CARGA_REEMPLAZOS", "18")
                    ...
                    <div class="row-fluid" style="padding-top:10px">
                        ...
                        <div class="span10">
                            <div class="alert alert-info">
                                <i class="icon-info-sign"></i> <strong>Importante:</strong> Los cajeros adicionales deben ser cargados hasta las <strong><%=horaLimiteReemplazos%>:00 hrs del día hábil anterior</strong> a la fecha en que deben presentarse en la sucursal. Las fechas en el archivo serán validadas automáticamente.
                            </div>
                        </div>
                    </div>
