...
<TR>
	...
	%></TD>
    <TD><%=rsReemplazos("hora_llegada")%></TD>
    <TD><%=rsReemplazos("hora_salida")%></TD>
    <TD><%=rsReemplazos("hora_reg_llegada")%></TD>
    <TD><%=rsReemplazos("hora_reg_salida")%></TD>
