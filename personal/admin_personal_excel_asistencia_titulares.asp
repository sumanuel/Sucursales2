...
'conex.Open "driver={SQL Server};server=lh-contoper-bd; database=; uid=usr_soporte; pwd=soporte"
...
'personal="select A.bt_sucursal,C.nombre_sucursal,A.rut_personal,B.nombre_personal+' '+B.apep_personal+' '+B.apem_personal as nombre,D.nombre_cargo,A.tipo,A.asistencia,A.fecha_reg,A.hora_reg,B.empresa,A.hora_llegada,A.hora_salida,A.hora_reg_llegada,A.hora_reg_salida from asistencia_personal A, personal B, sucursales C, cargos D where A.rut_personal=B.rut_personal and A.bt_sucursal=C.bt_sucursal and B.id_cargo=D.id_cargo and A.asistencia='no' and D.nombre_cargo='cajero' and A.fecha_reg=cast(GETDATE() as DATE) UNION select A.bt_sucursal,C.nombre_sucursal,A.rut_personal,B.nombre_reemp as nombre,D.nombre_cargo,A.tipo,A.asistencia,A.fecha_reg,A.hora_reg,B.empresa,A.hora_llegada,A.hora_salida,A.hora_reg_llegada,A.hora_reg_salida from asistencia_personal A, reemplazos B, sucursales C, cargos D where A.rut_personal=B.rut_reemp and A.bt_sucursal=C.bt_sucursal and B.id_cargo=D.id_cargo and A.asistencia='no' and  D.nombre_cargo='cajero adicional' and A.fecha_reg=cast(GETDATE() as DATE)" 
...
<TR>
    ...
    <TD><strong>Hora Reg. Llegada</strong></TD>
    <TD><strong>Hora Reg. Salida</strong></TD>
