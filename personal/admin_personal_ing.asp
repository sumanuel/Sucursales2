            	...
            	<br />                
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <br/><br/>-->
                            <% GlosaTbV1 = "Muestra las fechas correspondiente<br>a los ultimos 60 dias(2 meses). "%>
                           ...
                           <span>
                                 <i style="font-size: 14px" class="icon-question" data-toggle="popover" title="Glosa" data-trigger="hover" data-content="<%=GlosaTbV1%>"> </i>
                            </span>
                            <%sql = ""
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="row-fluid oculto" id="forms_add">
                        	<br/>
                            <div class="span12" id="forms_add2"></div>
                        </div>
                        <br/>
                        <div class="row-fluid">
