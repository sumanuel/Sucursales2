...
'Si no se obtuvo de LOGON_USER, intentar de la sesi?n
...
if usuarioLog <> "" then
	call registrarLog(usuarioLog, perfilLog, "Admin Personal", "Acceso a p?gina")
end if
                    ...
                    <span class="span10">
                        ...
                        <span class="btnGestionCasos" id="btnGestionCasos">
                            <a class="btn btn-danger" href="#">
                                ...
                                &nbsp;<span class="bajaLetra"><b>GESTI?N DE CASOS (GRAFICO)</b></span>
                            </a>
                        </span>
                        ...
                        &nbsp;&nbsp;
                         <span class="btnGestionCasosDetalle oculto" id="btnGestionCasosDetalle">
                            <a class="btn btn-danger btnGestionCasosDetalles" id="btnGestionCasosDetalles" href="#">
                                <i class="icon-book icon-large"></i>
                                &nbsp;<span class="bajaLetra"><b>GESTI?N DE CASOS (DETALLE)</b></span>
                            </a>
                        </span>
                        &nbsp;&nbsp;
                        ...
                        <span class="btnGestionProveedores" id="btnGestionProveedores">
                            <a class="btn btn-info" href="#">
                                ...
                                &nbsp;<span class="bajaLetra"><b>GESTI?N DE PROVEEDORES</b></span>
                            </a>
                        </span>
                        &nbsp;&nbsp;
                        <span class="">
            	...
            	<br />
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <br/><br/>
                            <span class="tool" rel="tooltip" title="(Listado con los registros s?lo de los cajeros y cajeros adicionales ausente.)">
                        ...
                        <div class="span10 offset1 well">
                        	<table width="100%" border="0" cellspacing="5" cellpadding="5">
                                ...
                                <tr>
                                    ...
                                    <td align="right" class="TextoNegro"><strong>Tipo Acci?n:</strong></td>
                                    <td>
                                ...
                                <tr>
                                    <td align="right" class="TextoNegro"><strong>Registros por P?gina:</strong></td>
                                    <td>
...
// Funci?n para cargar filtros din?micos de logs
...
// Funci?n para registrar logs de eventos del usuario
...
// Funci?n para buscar logs con paginaci?n
...
$('.btnGestionCasos').click(function(){
    registrarLog('Admin Personal - Gesti?n Casos', 'Ver gr?fico gesti?n casos');
...
$('.btnGestionCasosDetalle').click(function(){
    registrarLog('Admin Personal - Gesti?n Casos', 'Ver detalle gesti?n casos');
...
$('.btnGestionProveedores').click(function(){
    registrarLog('Admin Personal - Gesti?n Proveedores', 'Ver gesti?n de proveedores');
    $('.btnGestionCasos').addClass('oculto');
    $('.btnCuadroDeControl').addClass('oculto');
    $('.btnCuadroDeControl2').addClass('oculto');
    $('.btnGestionProveedores').addClass('oculto');
...
$('.btnSolicitudCajerosAdicionales').click(function(){
    registrarLog('Admin Personal - Solicitud Cajeros Adicionales', 'Ver solicitud cajeros adicionales');
    $('.btnGestionCasos').addClass('oculto');
    $('.btnCuadroDeControl').addClass('oculto');
    $('.btnCuadroDeControl2').addClass('oculto');
    $('.btnGestionProveedores').addClass('oculto');
...
$(function () {
	...
	registrarLog('Admin Personal - Gesti?n Personal', 'Agregar titular');
	...
	registrarLog('Admin Personal - Gesti?n Personal', 'Agregar reemplazo');
	var codBtt = $('option:selected','#sucursales').attr('data-codbt');
	var idSucursal = $('#sucursales').val();
	var $currentIFrame = $('#ifrmPIng');
