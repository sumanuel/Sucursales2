...
<table border="0" class="table table-bordered table-hover" align="center">
    ...
    <tr align="center">
        ...
        <td><i class="icon-file icon-large mano modPersonal" data-tipoPersonal="<%=tipo%>" data-idAsistPersonal="<%=id_asist_personal%>"></i></td>
        <td><i class="icon-trash icon-large mano delPersonal" data-idAsistPersonal="<%=id_asist_personal%>"></i></td>     
    </tr>  
    <%rs.MoveNext
	loop%>      
  </table>
