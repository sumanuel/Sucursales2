...
Dim id, fechaDesde, fechaHasta, usuario, logon_user
Dim cmd, rs, resultado_sp, mensaje_sp, idRetornado

id = Request.Form("id")
If id = "" Then id = Request.Form("id_eva")
fechaDesde = Request.Form("eva_fch_des")
fechaHasta = Request.Form("eva_fch_has")
...
If fechaDesde = "" Or fechaHasta = "" Then
	Response.Write "{""resultado"":""ERROR"",""mensaje"":""Debe indicar fecha desde y fecha hasta""}"
	Response.End
End If
