...
<table class="table table-bordered table-hover">
  ...
  <tbody>
    ...
    esActivo Dim estadoValor sqlEva = "EXEC dbo.SP_SUC_listar_eva_cajero
    @TOP_REGISTROS = 100" Set rsEva = db.Execute(sqlEva) If Err.Number <> 0 Then
    %>
    <tr>
    ...
    esActivo = False idEva = Trim(rsEva("ID_EVA") & "") If estadoTexto = "" Then
    estadoTexto = "SIN ESTADO" End If If estadoValor = "EN CAPACITACION" Then
    esActivo = True End If %>
    <tr>
