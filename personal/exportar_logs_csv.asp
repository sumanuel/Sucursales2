...
Response.AddHeader "Content-Disposition", "attachment; filename=reporte_logs_" & Replace(Date(), "/", "-") & ".csv"
...
contador = contador + 1
Response.Write(contador & ";" & _
rsLogs("usuario") & ";" & _
rsLogs("perfil") & ";" & _
rsLogs("funcionalidad") & ";" & _
rsLogs("tipo_accion") & ";" & _
FormatDateTime(rsLogs("fecha"), 2) & ";" & _
FormatDateTime(rsLogs("hora"), 4) & vbCrLf)
