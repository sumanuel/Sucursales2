          ...
          <div class="control-group">
            ...
            <div class="controls">
               	<select id="empresa">
                  	...
                  	<!--<option value="Guard Service SA">Guard Service SA</option>-->
                  	<!--<option value="P.P.I Chile">P.P.I Chile</option>-->
                    <option value="EULEN">EULEN</option>
                </select>
            </div>
          </div>
          <div class="row-fluid">
          ...
          <div class="control-group">
            ...
            <div class="controls">
            	<select id="motivo">
            		...
            		<option value="Falta Titular">Falta del Titular</option>
            		<option value="Curso OS-10">Curso OS-10</option>
            		<option value="Apoyo temporal">Apoyo temporal</option>
            		<option value="Renuncia titular">Renuncia titular</option>
