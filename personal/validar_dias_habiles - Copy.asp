<%
' VERSIÓN: 2025-12-03 18:35:00 - USA STORED PROCEDURE + FIX DB Connection
' Para verificar versión activa: Response.Write "validar_dias_habiles.asp v2025-12-03 18:35:00"
...
Function validarPlazoCarga(fechaInicio)
    ...
    ' Ejecutar stored procedure (usar DB en mayúsculas - conexión global)
    ...
    If Err.Number <> 0 Or rs.EOF Then
        ' Si hay error, RECHAZAR la carga por seguridad
        resultado.Add "valido", False
        resultado.Add "mensaje", "Error al validar plazo: " & Err.Description & " (SQL: " & sql & ")"
        resultado.Add "fechaLimite", ""
        resultado.Add "fechaLimiteConHora", ""
        resultado.Add "horaLimite", 17
        Err.Clear
    Else
