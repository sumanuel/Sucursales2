...
function posicion(posicionActual)
{
	...
	var idUsuarioMain = $.trim($('#idUsuarioMain').val());
	var pagina, div, datos;
	pagina = 'report/checkList2.asp';
	div = 'poneCheck';
	datos='idCarpeta='+actual+'&idUsuarioMain='+idUsuarioMain;
	console.log(datos)
...
/*$('#volverTabla').click(function(){
	...
	div = 'divMuestraCaja';
	datos='idSucursalCaja='+idSucursalCaja+'&idUsuarioMainCaja='+idUsuarioMainCaja;
	enviaDatos(pagina,div,datos);
});*/

$('#volverTabla').click(function(){
	$('#divCheck').slideUp('fast');
	$('#divCarpeta').slideDown('fast');
	$('#btnDescargaInformeDetalleCaja').show();
});
</script>