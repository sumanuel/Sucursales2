...
if not rs.eof then
	datos = rs.getRows()
 	...
 	for i= 0 to ubound(datos,2)
	 	...
	 	dmsNoIngresado = trim(datos(1,i))
		dmsValidado = trim(datos(2,i))
		dmsAlerta = trim(datos(3,i))
		dmsEnValidacion = trim(datos(4,i))
		dmsRecepcionado = trim(datos(5,i))
		dmsTotal = trim(datos(6,i))
...
idx_dmsNoIngresado = valorSucEnValidaDmsNoIngre + valorSucEnviadoDmsNoIngre + valorSucSinValidaDmsNoIngre + valorSucValidadoDmsNoIngre

'=====================================================================
	' Suma todas las filas y columnas
'=====================================================================
idx_sucColocaciones = valorSucEnValidaDmsNoIngre + valorSucEnValidaDmsValidado +valorSucEnValidaDmsAlerta + valorSucEnValidaDmsEnValida + valorSucEnValidaDmsRecepcionado + valorSucEnviadoDmsNoIngre + valorSucEnviadoDmsValidado + valorSucEnviadoDmsAlerta +valorSucEnviadoDmsEnValida + valorSucEnviadoDmsRecepcionado + valorSucSinValidaDmsNoIngre + valorSucSinValidaDmsValidado + valorSucSinValidaDmsAlerta + valorSucSinValidaDmsEnValida +valorSucSinValidaDmsRecepcionado + valorSucValidadoDmsNoIngre +valorSucValidadoDmsValidado +valorSucValidadoDmsAlerta + valorSucValidadoDmsEnValida + valorSucValidadoDmsRecepcionado+ valorSucEnNotarioDmsNoIngre +valorSucEnNotarioDmsValidado + valorSucEnNotarioDmsAlerta + valorSucEnNotarioDmsEnValida +valorSucEnNotarioDmsRecepcionado + valorSucRecepNotarioDmsNoIngre + valorSucRecepNotarioDmsValidado +valorSucRecepNotarioDmsAlerta + valorSucRecepNotarioDmsEnValida + valorSucRecepNotarioDmsRecepcionado + valorSucNoRecepNotarioDmsNoIngre + valorSucNoRecepNotarioDmsValidado 
