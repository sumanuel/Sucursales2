...
$("#formDatosCaja").validate({
    ...
    //alert(fechaEnvio);
    var valores = 'codigoBarras='+codigoBarras+'&valorEstado='+valorEstado+'&idAccion=2&botonera='+botonera+'&idUsuarioMain1='+idUsuarioMain+'&fechaEnvio='+fechaEnvio;
    ...
    $.ajax(
        {
            type:'GET',
            url:'report/sqlCajas.asp', //la pagina que se van los datos
            cache:false,
            global:false,
            dataType:"html",
            data:valores,
            ...
            {
                cargaIndicadoresCaja(); //Se agrega un actualizar indicadores cuando la caja pase a estar enviada
