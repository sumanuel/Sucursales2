...
<table border="0" class="table table-bordered table-hover" align="center">
    <tr bgcolor="" align="center">
        <td class="" width="8%"><strong>Rut Personal</strong></td>
        <td class="" width="13%"><strong>Nombre Completo</strong></td>        
        <td class="" width="2%"><strong>Cargo</strong></td>
        <td class="" width="2%"><strong>Tipo</strong></td>
        <td class="" width="2%"><strong>Empresa</strong></td>
        <td class="" colspan="2" width="2%" align="center"><strong>Asistencia</strong></td>
        <td class="" colspan="2" width="17%" align="center"><strong>Horario Entrada</strong></td>
        <td class="" colspan="2" width="17%" align="center"><strong>Horario Salida</strong></td>        
    </tr>
    <%
	arr_idasist = ""
	do while not rs.eof 
	...
	%>
    <tr align="center">
        <td align="center" style="font-size:11px"><%=rut_personal%></td>
        <td style="font-size:11px"><%=nombre_personal%></td>    
        <td style="font-size:11px" align="center"><%=tipo_personal%></td>    
        <td style="font-size:11px" align="center"><%=tipo%></td>
        <td style="font-size:11px" align="center"><%=empresa%></td>
        <td class="" align="center">        
			<select name="asistencia" style="font-size:11px;width:52px;" id="asist<%=id_asist_personal%>">
        ...
        <td class="" align="center">          
            <select name="hora_entrada" style="font-size:11px;width:50px;" id="eh<%=id_asist_personal%>">
            <% For h=0 to 23 
				if llegada_hora = "" then
					if h=8 then %>
            ...
            <select name="minuto_entrada" style="font-size:11px;width:50px;" id="em<%=id_asist_personal%>">
            <% For m=0 to 59 
				if llegada_min = "" then
					if m=45 then %>
        ...
        <td class="" align="center">        	
        	<select name="hora_salida" style="font-size:11px;width:50px;" id="sh<%=id_asist_personal%>">
            <% For h=0 to 23 
            ...
            <select name="minuto_salida" style="font-size:11px;width:50px;" id="sm<%=id_asist_personal%>">
            <% For m=0 to 59 
				if not salida_hora = "" then
...
%>  
  <table border="0" class="table table-bordered table-hover" align="center">
    <tr bgcolor="" align="center">
        ...
        <td class="" width="12%"><strong>Nombre</strong></td>
        <td class="" width="9%"><strong>Rut Reempl.</strong></td>
        <td class="" width="12%"><strong>Nombre Reempl.</strong></td>
        <td class="" width="5%"><strong>Cargo</strong></td>
        <td class="" width="14%" colspan="2"><strong>Fecha Desde - Hasta</strong></td>
        <td class="" width="10%" colspan="2"><strong>Hora Desde - Hasta</strong></td>
        <td class="" width="8%"><strong>Empresa</strong></td>
        <td class="" width="8%"><strong>Motivo</strong></td>
    </tr>   
    <%
	...
	%>     
    <tr align="center">
        <td style="font-size:11px" align="center"><%=r_rut_titular%></td>
        <td style="font-size:11px"><%=r_nombre_titular%></td>
        <td style="font-size:11px"><%=r_rut_reemp%></td>
        <td style="font-size:11px"><%=r_nombre_reemp%></td>
        <td style="font-size:11px"><%=r_nombre_cargo%></td>        
        <td style="font-size:11px" align="center"><%=r_desde%></td>
        <td style="font-size:11px" align="center"><%=r_hasta%></td>
        <td style="font-size:11px" align="center"><%=r_hora_ingreso%></td>
        <td style="font-size:11px" align="center"><%=r_hora_salida%></td>
        <td style="font-size:11px" align="center"><%=empresa%></td>
        <td style="font-size:11px" align="center"><%=r_motivo%></td>
    </tr>	
     <%rs2.MoveNext
	loop%>
   </table>  
