...
Dim id_solicitud_rebaja, id_estado_nuevo, comentario, usuario
...
If id_solicitud_rebaja = "" Or id_estado_nuevo = "" Then
...
' Construir SQL
Dim sql
sql = "EXEC SP_SUC_cambiar_estado_solicitud_rebaja "
