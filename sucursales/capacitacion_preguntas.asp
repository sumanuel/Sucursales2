...
%>
    ...
    <div class="row-fluid span12">
        ...
        <div class="row-fluid" id="idTablaSolicitudes">
            <div class="span12">
                <div class="row-fluid">
                    <div class="span12" style="display: flex; justify-content: flex-end; align-items: center; gap: 15px;">
                        ...
                        <div style="display: flex; align-items: center;">
                            <label style="margin: 0 10px 0 0; white-space: nowrap;">Registros por página:</label>
                            <select id="page_size_preguntas" style="width: 70px; margin: 0; display: inline-block;">
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if(data.preguntas.length === 0) {
                                    tbody.append('<tr><td colspan=5 style="text-align:center">No hay preguntas registradas</td></tr>');
                                } else {
    ...
    <div id="modalNuevaPregunta" class="modal hide fade" style="max-width: 900px;" tabindex="-1" role="dialog">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3>Nueva Pregunta</h3>
        </div>
        <!-- Agregamos un style para eliminar el padding inferior extra del body si fuera necesario -->
        <form id="formNuevaPregunta" class="form-horizontal" style="margin-bottom: 0;"> <!-- margin-bottom: 0 elimina la barra blanca -->
            <div class="modal-body" style="padding-bottom: 0;"> 
                    <div class="control-group">
                        <label class="control-label" for="txt_TituloNuevaPregunta">Título:</label>
                        <div class="controls">
                            <input type="text" class="span12" name="txt_TituloNuevaPregunta" id="txt_TituloNuevaPregunta" maxlength="50" placeholder="Máx. 50 caracteres" />
                        </div>
                    </div>
                    <div class="control-group" style="margin-bottom: 10px;"> <!-- Reducimos el margen del último grupo -->
                        <label class="control-label" for="txt_TextoNuevaPregunta">Pregunta:</label>
                        <div class="controls">
                            <textarea class="span12" name="txt_TextoNuevaPregunta" id="txt_TextoNuevaPregunta" rows="4" maxlength="500" style="resize: none;" placeholder="Máx. 500 caracteres"></textarea>
                        </div>
                    </div>
            </div>
