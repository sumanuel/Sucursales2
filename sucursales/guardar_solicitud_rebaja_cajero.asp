...
Dim id_solicitud_rebaja, id_sucursal, motivo, fecha_desde, fecha_hasta, periodo, observaciones, usuario, perfil

id_solicitud_rebaja = Request.Form("id_solicitud_rebaja")
If id_solicitud_rebaja = "" Then id_solicitud_rebaja = 0
...
Dim sql
sql = "EXEC SP_SUC_insertar_solicitud_cajero_rebaja "
sql = sql & "@id_solicitud_rebaja=" & id_solicitud_rebaja & ","
...
Else
    If Not rs.EOF Then
        If rs("resultado") = "OK" Then
            Response.Write "{""resultado"":""OK"",""id"":" & rs("id_solicitud_rebaja") & "}"
        Else
