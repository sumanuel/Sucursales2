...
<table border="1">
	...
	<tbody>
		...
		<%sql2 = ""
		sql2 = sql2 & "select id_usuario, zonal from SUC_zonales_comercial where estado_zonal = '1' "
		...
		if not rs2.eof then
			...
			For x = 0 to ubound(datos2, 2)
				...
				sql4 = sql4 & " (select id_sucursal from SUC_zonales_comercial_sucursal "
				...
				sql4 = sql4 & " and a.id_sucursal in (select id_sucursal from SUC_zonales_comercial_sucursal "
				sql4 = sql4 & " where id_zonal = '"&idZonal&"') "
				...
				sql3 = sql3 & " SUC_zonales_comercial_sucursal b "
...
Response.AddHeader "Content-Disposition", "attachment; filename=DetalleComercial.xls"  %>