...
if idZona = "" then idZona = "1" %>
<div class="" id="menuGer">
			<ul class="nav nav-tabs" id="idZona">
				...
				For i = 0 to ubound(datosZona, 2)
					...
					if idZona = idZonaSelecciona then 
						clase= "active"
					else
						clase = ""
					end if
					nombreZona = server.htmlencode(trim(datosZona(1,i)))%>
					<li data-idZona="<%=idZonaSelecciona%>" class="seleccionaZona <%=clase%>" id="idZona<%=idZonaSelecciona%>">
						<a href="#">
							<%=nombreZona%>
						</a>
					</li>
		...
		<table class="table table-bordered table-condensed" id="tablaDatosGerencia">
			...
			<tbody>
				...
				sql2 = sql2 & " zonal,id_usuario "
				sql2 = sql2 & " from suc_zonales "
				sql2 = sql2 & " where estado_zonal = '1' and id_zona = '"&idZona&"'"
				...
				for x=0 to ubound(datosZonal,2)
					...
					<tr class="abreTrSucursales mano muestra info" data-idZonal="<%=idZonal%>">
						...
						<td>
							<div id="detalleDocumentalZonal<%=idZonal%>" data-idTipo="2"><img src="img/loading.gif"></div>
						</td>
						<td>
							<div id="detalleContableZonal<%=idZonal%>" data-idTipo="3"><img src="img/loading.gif"></div>
						</td>
						<td>
							<div id="detalleAdministrativaZonal<%=idZonal%>" data-idTipo="4"><img src="img/loading.gif"></div>
						</td>
						<td>
						...
						<td>
							<div id="horaAperturaZonal<%=idZonal%>">
		                ...
		                <td>
							<div id="cajerosZonalA<%=idZonal%>"></div>
		                </td>
		                 <td>
		                    <div id="cajerosZonalSR<%=idZonal%>"></div>
						</td>
						<td>
					...
					for y=0 to ubound(datosSucursal,2)
						...
						<tr class="oculto <%=idZonal%>" id="trSucursal<%=idSucursal%>">
							<td>
								<span class="nombreSucursal" class="nombreSucursal" data-idSucursal="<%=idSucursal%>">
									<%=nombreSucursal%>
								</span>
							...
							<td><div id="detallePorcentajeDocSucursal<%=idSucursal%>"><img src="img/loading.gif"></div></td>
							<td><div id="detallePorcentajeContSucursal<%=idSucursal%>"></div></td>
							<td><div id="detallePorcentajeAdmSucursal<%=idSucursal%>"></div></td>
							<td><div id="detalleAperturaGer<%=idSucursal%>"></div></td>
							<td><div id="situacionSucursal<%=idSucursal%>"></div></td>
							<td>
